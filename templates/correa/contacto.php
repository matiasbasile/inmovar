            ...
            <div class="col-md-6">
              <div class="form-group">
                <select id="contacto_asunto" name="asunto" class="form-control">
                  <option value="Contacto desde web">Escoja Asunto</option>
...
<script type="text/javascript">
    ...
    L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw', {
      ...
      accessToken: 'pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw',
		...
		var icono = L.icon({
			iconUrl: 'assets/images/map-icon2.png',
	      iconSize:     [100, 109], // size of the icon
	      iconAnchor:   [50, 109], // point of the icon which will correspond to marker's location
	    });
