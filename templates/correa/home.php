		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						...
						<div class="row">
							...
							<div class="col-xl-3 col-md-6">
								...
								<select class="form-control" id="tp" name="tp">
									<option value="todas">Tipos Propiedades</option>
			...
			<section class="product-listing">
				<div class="container">
					...
					<div class="row">
						<?php $propiedades = $propiedad_model->get_list(array("destacado"=>1))?>
								...
								<div class="product-list-item">
									...
									<div class="product-details">
										...
										<div class="btns-block">
											...
											<a href="<?php echo mklink ($p->link) ?>#contacto_nombre" class="icon-box"></a>
