        ...
        <div class="col-lg-4 col-md-4">
          <div class="box_div_wrap">
            ...
            <div class="box_wrap_content">
              <?php $t = $web_model->get_text("box1tit","ventas")?>
              <h5 class="editable" data-id="<?php echo $t->id ?>" data-clave="<?php echo $t->clave ?>"><?php echo $t->plain_text ?></h5>
              <?php $t = $web_model->get_text("box1txt","Encontra la propiedad <br> que estas buscando al <br> mejor precio.")?>
              <p class="editable" data-id="<?php echo $t->id ?>" data-clave="<?php echo $t->clave ?>"><?php echo $t->plain_text ?></p>
              <a href="<?php echo mklink ("propiedades/ventas/") ?>">Ver Propiedades <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> 
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4">
          <div class="box_div_wrap">
            ...
            <div class="box_wrap_content">
              ...
              <p class="editable" data-id="<?php echo $t->id ?>" data-clave="<?php echo $t->clave ?>"><?php echo $t->plain_text ?></p>
              <a href="<?php echo mklink ("propiedades/alquileres/") ?>">Ver Propiedades <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> 
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-md-4">
          <div class="box_div_wrap">
            ...
            <div class="box_wrap_content">
              ...
              <p class="editable" data-id="<?php echo $t->id ?>" data-clave="<?php echo $t->clave ?>"><?php echo $t->plain_text ?></p>
              <a href="<?php echo mklink ("propiedades/emprendimientos/") ?>">Ver Propiedades <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a> 
            </div>
          </div>
        </div>
      </div>
