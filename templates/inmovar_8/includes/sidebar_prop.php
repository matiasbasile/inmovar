...
<div class="rightsidebar custom_select_arrow">
  ...
  <div class="first_tab">
    ...
    <ul class="box_footer_btm">
      <li class="w100p">
        <a href="<?php echo mklink("admin/propiedades/function/ficha/".$propiedad->hash) ?>" rel="nofollow" target="_blank">
          <i class="fa fa-file-text-o" aria-hidden="true"></i> Imprimir Ficha
        </a>
      </li>
      <?php /*
