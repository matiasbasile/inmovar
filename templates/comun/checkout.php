...
$ll = array(
  ...
  "registro_celular_placeholder"=>"Sin 0 ni 15",
...
$carrito_id_pais = ((isset($empresa->config["carrito_id_pais"])) ? $empresa->config["carrito_id_pais"] : 1);
?>
              ...
              <div class="varcreative-panel-body">
                ...
                <div class="row">
                  ...
                  <?php if (isset($empresa->tienda_registro_telefono) && $empresa->tienda_registro_telefono == 1) { ?>
                    <div class="varcreative-col6">
                      <div class="varcreative-form-group">
                        <input type="number" class="varcreative-input" onfocus="add_placeholder(this)" onblur="remove_placeholder(this)" data-placeholder="<?php echo $ll["registro_celular_placeholder"] ?>" required id="registro_telefono" value="<?php echo(isset($carrito->telefono)?$carrito->telefono:"") ?>" name="telefono" />
                  ...
                  <div id="datos_direccion">
                    ...
                    if ($metodo_envio->forma_envio == "MERCADOENVIOS") { ?>
                      ...
                      // PEDIMOS EL CODIGO POSTAL AL USUARIO
                        ...
                        <?php if (isset($empresa->tienda_registro_provincia) && $empresa->tienda_registro_provincia == 1) { ?>
                          <div class="varcreative-form-group">
                            <select <?php echo isset($empresa->config["carrito_id_provincia_disabled"]) ? "disabled":"" ?> name="id_provincia" class="varcreative-input provincia_select" id="registro_provincia_2">
                              <option value="0"><?php echo $ll["provincia"] ?></option>
                              <?php 
                              $sql_provincia = "SELECT * FROM com_provincias WHERE 1=1 ";
                              $sql_provincia.= "AND id_pais = $carrito_id_pais ";
          ...
          // ULTIMO PASO: MOSTRAMOS EL RESUMEN DE TODO LO ELEGIDO
            ...
            <div class="varcreative-panel panel_activo">
              ...
              <div class="varcreative-option-btn">
                ...
                <?php echo ($carrito->forma_pago == "paypal") ? "Paypal" : ""; ?>
                <?php echo ($carrito->forma_pago == "stripe") ? "Stripe" : ""; ?>
