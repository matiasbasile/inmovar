      ...
      <div class="col-xl-4">
        ...
        <div class="white-box">
          ...
          <form id='form_whatsapp_sidebar' onsubmit="return false">
            ...
            <textarea class="form-control contacto_mensaje">Me comunico desde La Comu interesado en <?php echo $propiedad->nombre ?> (Cod: <?php echo $propiedad->codigo ?>) <?php echo $propiedad->link_propiedad ?></textarea>
