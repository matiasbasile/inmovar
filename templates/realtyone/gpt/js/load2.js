...
function init() {
    var base = "https://comunidadinmobiliaria.com.ar/templates/lacomunidad/gpt/";
    var iframe = document.createElement('iframe');
    iframe.src = base+"chatgpt.php?domain=" + window.location.hostname;
