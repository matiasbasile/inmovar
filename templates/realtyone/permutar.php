          ...
          <div class="white-box">
            <div class="comunicate">
             <div class="icon-box">
              ...
              <div class="right-text">
               <h5>DATOS DE LA PROPIEDAD A ENTREGAR</h5>
               <b>INDIQUE EL TIPO DE PROPIEDAD QUE QUIERE ENTREGAR</b>
              </div>
            </div>
          ...
          <div class="white-box">
            <div class="comunicate">
             <div class="icon-box">
              ...
              <div class="right-text">
               <h5>DATOS DE LA PROPIEDAD A RECIBIR</h5>
               <b>INDIQUE EL TIPO DE PROPIEDAD QUE QUIERE RECIBIR</b>
              </div>
            </div>
            ...
            <div class="form">
              <div class="row">
                <div class="col-md-6 col-sm-12">
                  <input id="propiedad_2_ubicacion" type="text" class="form-control propiedad_2_ubicacion" placeholder="Ubicación">
                </div>
                <div class="col-md-6 col-sm-12">
                  <select class="form-control propiedad_2_tipo_propiedad" id="propiedad_2_tipo_propiedad">
                    <option value="0">Tipo de propiedad</option>
                    <?php $tipo_propiedades = $propiedad_model->get_tipos_propiedades(); ?>
                    <?php foreach ($tipo_propiedades as $tipo) { ?>
                      <option value="<?php echo $tipo->nombre ?>"><?php echo $tipo->nombre ?></option>
                ...
                <div class="col-md-6 col-sm-12">
                  <select class="form-control propiedad_2_dormitorios" id="propiedad_2_dormitorios">
                    <option value="0">Dormitorios</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                ...
                <div class="col-md-6 col-sm-12">
                  <select class="form-control propiedad_2_banios" id="propiedad_2_banios">
                    <option value="0">Baños</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                ...
                <div class="col-md-6 col-sm-12">
                  <select class="form-control propiedad_2_cochera" id="propiedad_2_cochera">
                    <option value="0">Cochera</option>
                    <option value="1">1</option>
                    <option value="2">2</option>
                    <option value="3">3</option>
                ...
                <div class="col-md-6 col-sm-12">
                  <input id="propiedad_2_metros" type="number" class="form-control propiedad_2_metros" placeholder="Cantidad de metros">
                </div>
...
function validar_ventas() {
  ...
  var propiedad_2_tipo_propiedad = $("#form_ventas").find(".propiedad_2_tipo_propiedad").val();
  var propiedad_2_ubicacion = $("#form_ventas").find(".propiedad_2_ubicacion").val();
  var propiedad_2_dormitorios = $("#form_ventas").find(".propiedad_2_dormitorios").val();
  var propiedad_2_banios = $("#form_ventas").find(".propiedad_2_banios").val();
  var propiedad_2_cochera = $("#form_ventas").find(".propiedad_2_cochera").val();
  var propiedad_2_metros = $("#form_ventas").find(".propiedad_2_metros").val();
  ...
  var observaciones = "";
  observaciones += "PROPIEDAD A ENTREGAR: \n";
  ...
  observaciones += "PROPIEDAD A RECIBIR: \n";
  observaciones += "Ubicacion: "+propiedad_2_ubicacion+"\n";
  observaciones += "Tipo de Propiedad: "+propiedad_2_tipo_propiedad+"\n";
  observaciones += "Dormitorios: "+propiedad_2_dormitorios+"\n";
  observaciones += "Baños: "+propiedad_2_banios+"\n";
  observaciones += "Cocheras: "+propiedad_2_cochera+"\n";
  observaciones += "Metros Cuadrados: "+propiedad_2_metros+"\n";
