          ...
          <div class="img-list-btns">
            <div class="row">
              <?php if ($propiedad->video) { ?>
                <div class="col-md-4"><a href="<?php echo $propiedad->video_original ?>" class="fancybox" data-fancybox-group="gallery" class="btn btn-primary btn-block"><i class="fa fa-video-camera mr-3" aria-hidden="true"></i> recorre la propiedad</a></div>
              <?php } ?>
