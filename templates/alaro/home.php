		...
		<div class="swiper-wrapper">
			<?php foreach ($slides as $s) {  ?>
				<div class="swiper-slide">
					<img class="img-cover" src="<?php echo $s->path ?>" <?php if (!empty($s->path_movil)) { ?> srcset="<?php echo $s->path_movil ?> 968w, <?php echo $s->path ?> 1024w" size="(max-width: 968px) 968px, (min-width: 969px) 1024px" <?php } ?> />
				...
				<div class="feature-item">
					<div class="feature-image"> <a class="principal" href="<?php echo mklink($p->link) ?>"><img src="/admin/<?php echo $p->path ?>" alt="Product" /></a>
						<?php if (!empty($p->etiquetas)) {  ?>
							<div class="label-text"><?php foreach ($p->etiquetas as $etiq) {
																				echo $etiq->nombre;
																			} ?></div>
						<?php } ?>
							...
							<div class="center-content">
								<div class="align-center">
									<div class="center-title">
										...
										<span><?php echo $p->direccion_completa ?><br>
			...
			<div class="container">
				...
				<div class="row" id="destacados">
					<?php foreach ($destacados as $d) {  ?>
						...
						<?php $name = str_replace("VENTA", "", $d->nombre) ?>
						...
						<div class="col-md-4">
							<div class="feature-item">
								...
								<div class="feature-info">
									<h3><?php echo $name ?></h3>
									<h5>
										<?php echo $d->direccion_completa ?>
										<?php if (!empty($d->localidad)) { ?>
											<?php echo ($d->localidad); ?>
										<?php } ?>
									</h5>
