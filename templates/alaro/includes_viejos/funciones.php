...
function format($n,$consultar = true) {
...
function mostrar_etiqueta($p) {
    if (!isset($p->etiquetas)) return;
    foreach($p->etiquetas as $etiq) {
        if ($etiq->link == "ultimas") {
            echo '<div class="project-state ultimas"></div>';
            return;
        } else if ($etiq->link == "premium") {
            echo '<div class="project-state premium"></div>';
            return;            
        } else if ($etiq->link == "vendido") {
            echo '<div class="project-state vendido"></div>';
            return;            
        } else if ($etiq->link == "terminado") {
            echo '<div class="project-state terminado"></div>';
            return;            
        } else if ($etiq->link == "oportunidad") {
            echo '<div class="project-state oportunidad"></div>';
            return;            
        }
    }
}
