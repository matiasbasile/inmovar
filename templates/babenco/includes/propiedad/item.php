...
function propiedad_item($r) { ?>
  <div class="property-box">
    ...
    <div class="btn-actions">
      ...
      <a class="btn btn-green" href="javascript:void(0)" rel="nofollow" onclick="abrirModal('whatsapp','Estoy interesado en <?php echo $r->nombre ?> Cod: <?php echo $r->codigo ?>','<?php echo $r->id ?>')">
