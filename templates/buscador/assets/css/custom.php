...
@media (max-width: 768px) {
  ...
  .page-search-results .btn-limpiar { border-radius: 25px; font-size: 12px; display:inline-block; background-color:#dddddd;color:#5a5a5a; cursor:pointer; padding:3px 7px; }
