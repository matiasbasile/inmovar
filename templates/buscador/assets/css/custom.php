...
.form-map input:-moz-placeholder { /* Firefox 18- */
color: white !important;  
}
 
.form-map input::-moz-placeholder {  /* Firefox 19+ */
color: white !important;  
}
...
.navigation .navbar .navbar-nav > li > .child-navigation > li:first-child:hover a:hover:after {
    border-color: transparent transparent <?php echo $c1; ?> transparent;
}
...
.geo-location-wrapper .text:after {
  ...
  border-style: solid;
  border-width: 4px 0 4px 4px;
  border-color: transparent transparent transparent <?php echo $c2 ?>;
  position: absolute;
  top: 0;
  right: -4px;
  bottom: 0;
...
.faq .icon:after {
  ...
  border-color: transparent <?php echo $c1; ?> transparent transparent;
  position: absolute;
  right: 0;
  width: 0px;
}
...
.price-box.promoted {
  background-color: <?php echo changeBrightness($c2,-30) ?>;
  border: none;
}
...
.my-search-box .container { padding: 0 200px }
.my-search-box h2 { color: #FFF;font-size: 40px;line-height: 42px;text-align: center;margin-bottom: 20px;text-shadow: 1px 2px 2px rgba(0, 0, 0, 0.79);}

.my-select { width: 100% !important; background: rgba(255, 255, 255, 0.94);}
...
.my-select.button:hover {  background-color: <?php echo $c2; ?> !important; }

.my-select:hover { background: rgba(255,255,255,0.94) !important }
...
#sidebar .sidebar-navigation > li a:hover:after {
  filter: progid:DXImageTransform.Microsoft.Alpha(enabled=false);
  opacity: 1;
  border-color: transparent transparent transparent <?php echo $c1; ?>;
}
...
#slider .carousel .item .overlay .info {
  filter: progid:DXImageTransform.Microsoft.Alpha(enabled=false);
  opacity: 1;
  -moz-transition: 0.2s;
  -webkit-transition: 0.2s;
...
#slider .carousel .item .overlay .info .tag {
  filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=0);
  opacity: 1;
  -moz-transition: 0.4s;
  -webkit-transition: 0.4s;
...
#slider .carousel .item .overlay .info h3 {
...
#slider .carousel .item .overlay .info figure {
...
#slider .carousel .item .overlay .info.animate-description-out {
  filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=0);
  opacity: 1;
}
#slider .carousel .item .overlay .info.animate-description-out .tag, #slider .carousel .item .overlay .info.animate-description-out h3, #slider .carousel .item .overlay .info.animate-description-out figure {
  filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=0);
  opacity: 1;
}
#slider .carousel .item .overlay .info.animate-description-in {
  filter: progid:DXImageTransform.Microsoft.Alpha(enabled=false);
  opacity: 1;
}
#slider .carousel .item .overlay .info.animate-description-in figure {
  filter: progid:DXImageTransform.Microsoft.Alpha(enabled=false);
  opacity: 1;
...
#slider .carousel .item .overlay .info.animate-description-in h3 {
  filter: progid:DXImageTransform.Microsoft.Alpha(enabled=false);
  opacity: 1;
  -moz-transition-delay: 0.2s;
  -webkit-transition-delay: 0.2s;
...
#slider .carousel .item .overlay .info.animate-description-in .tag {
  filter: progid:DXImageTransform.Microsoft.Alpha(enabled=false);
  opacity: 1;
  top: 0px;
}
#slider .carousel .item .overlay hr {
  filter: progid:DXImageTransform.Microsoft.Alpha(Opacity=20);
  opacity: 0.2;
  border-color: #fff;
}
#slider .carousel .item .overlay .link-arrow {
  color: #fff;
}
#slider .carousel .item img {
  position: relative;
}
#slider .carousel .owl-controls .owl-prev, #slider .carousel .owl-controls .owl-next {
  -moz-transition: 0.4s;
  -webkit-transition: 0.4s;
  transition: 0.4s;
  background-color: transparent;
...
#slider .carousel .owl-controls .owl-prev:hover, #slider .carousel .owl-controls .owl-next:hover {
  background-color: rgba(0, 0, 0, 0.2);
}
#slider .carousel .owl-controls .owl-prev:after, #slider .carousel .owl-controls .owl-next:after {
  text-shadow: none;
  -webkit-font-smoothing: antialiased;
  font-family: 'fontawesome';
  speak: none;
...
#slider .carousel .owl-controls .owl-next {
  right: 0;
}
#slider .carousel .owl-controls .owl-next:after {
  content: "\f105";
  right: 20px;
}
#slider .carousel .owl-controls .owl-prev:after {
  content: "\f104";
  left: 0px;
}
...
.leaflet-popup .leaflet-popup-content-wrapper .leaflet-popup-content {
  ...
  border-top: 5px solid <?php echo $c2 ?>;
  height: 206px;
  width: 260px;
  margin: 0;
  overflow: hidden;
...
.infobox-wrapper .infobox-inner {
  ...
  background: #fff;
  border-top: 6px solid <?php echo $c2 ?>;
  font-size: 12px;
  position: relative;
  margin-bottom: 50px;
  min-width: 200px;
...
.btn.btn-default:hover, select.btn-default:hover {
  background-color: <?php echo changeBrightness($c1,30); ?>;
}
...
.jslider .jslider-pointer {
  ...
  -webkit-box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.2);
  box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.2);
  background: url("../img/price-range-dragger.png") no-repeat 50% 50% <?php echo $c1; ?>;
  height: 14px;
  width: 14px;
  top: 12px;
}
...
.form-search select, #search-filter .sorting select {
  min-height: 40px;
  height: 40px;
  padding: 10px 9px 9px 9px;
  width: 100%;
...
.horizontal-search .search-box-wrapper .search-box .nav-pills li a:after {
  ...
  border-color: <?php echo $c2 ?> transparent transparent transparent;
  content: "";
  position: absolute;
  left: 0;
  right: 0;
...
@media (max-width: 768px) {
  #slider, #slider .carousel .item { height: 400px !important; }
  #slider .carousel .item .overlay { top: 120px; }
}
...
@media (max-width: 767px) {
  ...
  .search-box-wrapper input[type="text"], .search-box-wrapper input[type="email"], .search-box-wrapper input[type="search"], .search-box-wrapper input[type="password"], .search-box-wrapper input[type="number"], .search-box-wrapper textarea.form-control, .search-box-wrapper select {
...
/* SHARE BLOCK CSS */
.share-block{float:left; width:100%;}
.share-block h6{margin-bottom:25px;}
.share-block ul { list-style: none; }
.share-block ul li{float:left;}
.share-block ul li a{float:left; width:42px; height:40px; font-size:18px; color:#fff; border-radius:2px; -webkit-border-radius:2px; line-height:40px;  text-align:center; margin-right:5px;}
.share-block ul li a:hover, .share-block ul li a:focus{opacity:0.7;}
.share-block ul li a.fb{background:#516eab;}
.share-block ul li a.twitter{background:#29c5f6;}
.share-block ul li a.google{background:#eb4026;}
.share-block ul li a.mail{background:#7511b9;}
.share-block ul li a.send{background:#0088cc;}
.share-block ul li a.whatsapp{background:#7bbf6a;}

.whatsapp_cont { display: table; width: 100%; margin-top: 30px; margin-bottom: 20px; }
.whatsapp_cont .whatsapp_cont_icon { display: table-cell; vertical-align: middle }
.whatsapp_cont .whatsapp_cont_icon .fa { color: #1bc035; font-size: 42px; margin-right: 5px; }
.whatsapp_cont .whatsapp_cont_texto { display: table-cell; vertical-align: middle }
.whatsapp_cont .whatsapp_cont_texto span { font-size: 14px; font-weight: normal; }
.whatsapp_cont .whatsapp_cont_texto h3 { font-size: 20px; margin: 0px; padding: 0px; font-weight: bold; }
.whatsapp_cont .whatsapp_cont_texto h3 a { color: inherit; text-decoration: none; }
...
.alto { height: 200px; object-fit: cover; object-position: center; width: 100%; }
.alto-2 { max-height: 500px; object-fit: contain; object-position: center; width: 100%; }
...
#map-view, #list-view { display:none !important; }
...
#contacto_dos_botones .btn-whatsapp { background-color: #20be3a !important; border-color: #20be3a !important; color: white !important; display: block; text-align:center;width:100%;border-radius:10px }
#contacto_dos_botones .btn-buscar { display:block; width:100%;border-radius:10px}
...
@media (max-width: 768px) {
  #form_flotante, #contacto-section > header, #contacto_dos_botones { display: none; }
  #form_flotante.active, #contacto_solo_boton, #form_flotante > header { display: block; }
  ...
  .page-search-results .operaciones-flotante .button.active, 
