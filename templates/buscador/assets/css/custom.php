...
@media (max-width: 768px) {
  ...
  .page-search-results .buscador-flotante .btn-limpiar { font-size: 14px; outline: none !important; padding: 10px 9px 9px 9px; background-color: #e1e1e1;color: #838383; box-shadow: 0px 1px 1px rgb(0 0 0 / 20%);border-radius: 10px; }
