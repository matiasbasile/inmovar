...
@media (max-width: 768px) {
  ...
  .page-search-results .buscador-flotante .button:active, .page-search-results .operaciones-flotante .button:active { background-color: <?php echo $c1; ?> !important; color: white !important; }
