...
class Clientes extends REST_Controller {
  ...
  function enviar_sms_verificacion() {
    ...
    if (!empty($cliente) && $this->Empresa_Model->es_toque($id_empresa)) {
      ...
      if ($template !== FALSE) {
        ...
        $body = str_replace("{{link}}", "https://www.varcreative.com/admin/clientes/function/registro_valido/?".$pars, $body);        
  ...
  function importar_arecocard() {
    ...
    if (move_uploaded_file($_FILES["file"]["tmp_name"],$file)) {
      ...
      header("Location: http://varcreative.com/admin/app/#inicio");
    }
  }
