...
class Importacion_Xintel_Model extends Abstract_Model {
  ...
  function importar_xintel($url =  "http://xintel.com.ar/api/?json=resultados.fichas&suc=JYB&apiK=4m17zq256jvsm24wOnqbev43y&page=0") {
    ...
    foreach ($result->resultado->fichas as $p) {
      ...
      $sql = "SELECT id FROM inm_propiedades WHERE codigo = '$p->in_num' AND id_empresa = '$id_empresa' ";
      $q = $this->db->query($sql);
      ...
      if ($q->num_rows()==0) {
        ...
        //TODO: HACER CURL DE CADA PROPIEDAD PARA TRAER LAS IMAGENES
        //https://xintel.com.ar/api/?cache=12032021&json=fichas.propiedades&amaira=false&suc=JYB&global=LU3AIKPR4F6ZSUY8GQODKWRO8&emprendimiento=True&oppel=&esweb=&apiK=4m17zq256jvsm24wOnqbev43y&id=696&_=1615575453648
