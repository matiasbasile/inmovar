<script type="text/template" id="wpp_templates_panel_template">
<% if (seleccion) { %>
  ...
  <div class="modal-body">
    ...
    <div class="table-responsive" style="overflow: auto; max-height: 400px">
      <table id="wpp_templates_table" data-ordenable-table="email_template" data-ordenable-where="" class="table table-small table-striped ordenable m-b-none default footable">
        <thead>
          <tr colspan="2">
  ...
  <div class="panel panel-default" style="border: none;">
    ...
    <div class="panel-body">
      <div class="table-responsive">
        <table id="wpp_templates_table" data-ordenable-table="email_template" data-ordenable-where="" class="table table-striped ordenable m-b-none default footable">
          <thead>
            <tr>
...
<script type="text/template" id="wpp_templates_item">
...
<script type="text/template" id="wpp_templates_edit_panel_template">
<% if (!lightbox) { %>
            ...
            <div class="panel-body">
              <div class="padder">
                <div class="form-group">
                  ...
                  <input type="text" name="nombre" class="form-control" id="wpp_templates_nombre" value="<%= nombre %>"/>
                </div>
                <?php if (isset($volver_superadmin) && $volver_superadmin == 1) { ?>
                  <div class="form-group">
                    <label class="control-label"><?php echo lang(array("es"=>"Clave","en"=>"Key")); ?></label>
                    <input type="text" name="clave" class="form-control" id="wpp_templates_clave" value="<%= clave %>"/>
                  </div>
                <?php } ?>
                <div class="form-group">
                  <textarea name="texto" id="wpp_templates_texto"><%= texto %></textarea>
                </div>
              </div>
            </div>
          </div>
  ...
  <% } else { %>
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          <label for="wpp_templates_nombre">Nombre</label>
          <input type="text" name="nombre" value="<%= nombre %>"  id="wpp_templates_nombre" class="form-control">
        </div>
        <% if (VOLVER_SUPERADMIN == 1) { %>
          <div class="form-group">
            <label for="wpp_templates_clave">Key</label>
            <input type="text" name="clave" value="<%= clave %>" id="wpp_templates_clave" class="form-control">
          </div>
        <% } %>
        <label for="wpp_templates_texto">Texto</label>
        <textarea name="texto" id="wpp_templates_texto"><%= texto %></textarea>
      </div>
