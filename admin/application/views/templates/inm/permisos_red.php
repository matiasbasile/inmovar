        ...
        <ul class="nav nav-tabs nav-tabs-2" role="tablist">
          <li id="buscar_propias_tab" class="buscar_tab active">
            <a href="javascript:void(0)">
              <i class="material-icons">store</i> Inmobiliarias La Plata
              <span id="propiedades_total_la_plata" class="counter"><%= results_lp.length %></span>
            </a>
          </li>
          <li id="buscar_propias_tab_caba" class="buscar_tab">
            <a href="javascript:void(0)">
              <i class="material-icons">store</i> Inmobiliarias CABA
              <span id="propiedades_total_caba" class="counter"><%= results_caba.length %></span>
            </a>
          </li>
          <li>
          ...
          <div class="">
            ...
            <div class="">
              <table id="permisos_red_tabla" class="table table-striped sortable m-b-none default footable">
                ...
                <tbody id="tbody_lp" class="tbody">
                  <% for(var i=0;i< results_lp.length;i++) { %>
                    <% var m = results_lp[i] %>
                    <tr data-id="<%= m.id %>">
                      <td class="p0">
                        <% if (!isEmpty(m.logo)) { %>
                ...
                <tbody id="tbody_caba" class="tbody">
                  <% for(var i=0;i< results_caba.length;i++) { %>
                    <% var m = results_caba[i] %>
                    <tr data-id="<%= m.id %>">
                      <td class="p0">
                        <% if (!isEmpty(m.logo)) { %>
                          <img src="/admin/<%= m.logo %>" class="customcomplete-image mt5 mb5"/>
