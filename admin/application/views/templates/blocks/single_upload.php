...
<div class="form-group upload_container">
    ...
    <?php } ?>
        ...
        <img id="preview_<?php echo $name; ?>" class="img_preview" style="max-width: 150px; display:<%= (display_file)?'inline-block':'none' %>" src="<%= <?php echo $name ?>+"?t="+Math.ceil(Math.random()*1000) %>"/>
