		...
		<div class="a4">
			<div class="inner">
				<div id="invoice" class="new"><!-- INVOICE -->
	              ...
	              if (isset($factura->cliente->provincia) && !empty($factura->cliente->provincia)) {
	              	echo "Provincia: ".$factura->cliente->provincia."<br/>";
	              }
	              ...
	              if (isset($factura->cliente->telefono) && !empty($factura->cliente->telefono)) {
	                echo "Tel&eacute;fono: ".$factura->cliente->telefono."<br/>";
								...
								<?php if ($empresa->id == 758) { ?>
									...
									<br/>
									CCFIT<br/>
									Paroissien 1967 Pb A (1429). Capital Federal
								<?php } ?>
