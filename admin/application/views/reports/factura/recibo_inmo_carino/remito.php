          ...
          <div class="col-xs-12 bodyprint">
            ...
            <div class="col-xs-12">
              <div style="font-size: 13px; line-height: 17px; ">
                ...
                LA SUMA DE <?php echo ($factura->moneda == 'U$D') ? 'BILLETES DOLARES ESTADOUNIDENSES' : 'PESOS' ?> <?php echo strtoupper($letras->ValorEnLetras($total)) ?>
                ...
                <tbody>
                  <?php if ($factura->monto != 0) { ?>
                    <tr>
                      ...
                      <td class="tar pr5">$ <?php echo round($factura->monto,0); ?></td>
                    </tr>
                  <?php } ?>
